...
<div class="row">
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
        ...
        <input type="text" name="value1" placeholder="Width">
        ...
        if(isset($_POST['areaButton']) && is_numeric($_POST['value1']) && is_numeric($_POST['value2'])) {
            ...
            $result = $performStrategy->performArea(new Rectangle, $value1, $value2);
            echo $result;
        }
        ?>
    </h2>
    ...
    <div class="col-md-2">
        ...
        <h4>h - height</h4>
        <h4>a - area</h4>
        <h4><strong>a = w * h</strong></h4>
    </div>
    <div class="col-md-2">
    <img src="<?php echo ROOT; ?>assets/images/rectangle.png" alt="rectangle">
    </div>
</div>
